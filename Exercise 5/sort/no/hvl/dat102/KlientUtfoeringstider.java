...
import static no.hvl.dat102.SorteringOgSoeking.kvikkSortNy;
...
public class KlientUtfoeringstider {
	...
	public static void runSortingAlgorithm(Sorteringsalgoritme sortType, Integer[] elementer) {
		...
		case KVIKK:
			...
			break;
		case KVIKKSORTNY:
			kvikkSortNy(elementer, 0, elementer.length-1);
		case FLETTING:
	...
	public static void main(String[] args) {
		...
		//Mål tiden på ny kvikksort
		System.out.println();
		System.out.println("\nORIGINAL KVIKKSORT");
		utfoerSorteringEstimering(Sorteringsalgoritme.KVIKK, SIZE_32K);
		System.out.println();
		System.out.println("\nNY KVIKKSORTERING");
		utfoerSorteringEstimering(Sorteringsalgoritme.KVIKKSORTNY, SIZE_32K);
